...
public class Pais extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Pais     "));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Pais   "));
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Pais Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Pais Inactivado");
                limpiarTabla(model);
