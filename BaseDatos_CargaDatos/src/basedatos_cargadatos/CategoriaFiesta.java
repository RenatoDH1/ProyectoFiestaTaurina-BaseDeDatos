 ...
 * @author Nando
 */
public class CategoriaFiesta extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CATEGORIA DE FIESTA");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Categoria de Fiesta"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Categoria_Fiesta  "));
    ...
    void Agregar() {
        ...
        try {
            if (cod.equals("") || nom.equals("")|| estado.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Categoria de Fiesta Registrado con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        ...
        try {
            if (estado != null || nom != null) {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Categoria de Fiesta Modificado");
                limpiarTabla(model);
        ...
        if (fila < 0) {
            JOptionPane.showMessageDialog(null,"Categoria de Fiesta no Seleccionado");
                ...
                try {
                    ...
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Categoria de Fiesta Eliminado");
                    limpiarTabla(model);
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Categoria de Fiesta Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Categoria de Fiesta Inactivado");
                limpiarTabla(model);
    ...
    public static void main(String args[]) {
        ...
        new CategoriaFiesta().setVisible(true);
