 ...
 * @author Nando
 */
public class RepresentanteMatador extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REPRESENTANTE MATADOR");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Representante Matador"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Representante_Matador  "));
    ...
    public void VentanaInicio() {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RepresentanteMatador().setVisible(true);
            }
        });
    }
    void listar(){
...
//            model=new DefaultTableModel(null,Titulos);   
    ...
    void Agregar() {
        ...
        try {
            if (cod.equals("") || nom.equals("")|| estado.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Representante Matador Registrado con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        ...
        try {
            if (estado != null || nom != null) {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Representante Matador Modificado");
                limpiarTabla(model);
        ...
        if (fila < 0) {
            JOptionPane.showMessageDialog(null,"Representante Matador no Seleccionado");
                ...
                try {
                    ...
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Representante Matador Eliminado");
                    limpiarTabla(model);
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Representante Matador Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Representante Matador Inactivado");
                limpiarTabla(model);
