...
public class Premio extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Premio     "));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Premio  "));
    ...
    void Agregar() {
        ...
        try {
            if (cod.equals("") || nom.equals("")|| estado.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Premio Registrado con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        ...
        try {
            if (estado != null || nom != null) {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Premio Modificado");
                limpiarTabla(model);
        ...
        if (fila < 0) {
            JOptionPane.showMessageDialog(null,"Premio no Seleccionado");
                ...
                try {
                    ...
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Premio Eliminado");
                    limpiarTabla(model);
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Premio Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Premio Inactivado");
                limpiarTabla(model);
