 ...
 * @author Nando
 */
public class TipoAsiento extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Tipo de Asiento"));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Tipo_Asiento  "));
    ...
    void Agregar() {
        ...
        try {
            if (cod.equals("") || nom.equals("")|| estado.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Tipo de Asiento Registrado con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        ...
        try {
            if (estado != null || nom != null) {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Asiento Modificado");
                limpiarTabla(model);
        ...
        if (fila < 0) {
            JOptionPane.showMessageDialog(null,"Tipo de Asiento no Seleccionado");
                ...
                try {
                    ...
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Tipo de Asiento Eliminado");
                    limpiarTabla(model);
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Asiento Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Asiento Inactivado");
                limpiarTabla(model);
    ...
    public static void main(String args[]) {
        ...
        new TipoAsiento().setVisible(true);
