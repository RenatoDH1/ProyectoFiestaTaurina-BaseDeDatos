 ...
 * @author Nando
 */
public class TipoMatador extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TIPO DE MATADOR");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Registro de Tipo de Matador     "));
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("Tabla_Tipo_Matador  "));
    ...
    void Agregar() {
        ...
        try {
            if (cod.equals("") || nom.equals("")|| estado.equals("")) {
                ...
                JOptionPane.showMessageDialog(null, "Tipo de Matador Registrado con Exito");
                limpiarTabla(model);
    ...
    void Modificar() {
        ...
        try {
            if (estado != null || nom != null) {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Matador Modificado");
                limpiarTabla(model);
        ...
        if (fila < 0) {
            JOptionPane.showMessageDialog(null,"Tipo de Matador no Seleccionado");
                ...
                try {
                    ...
                    st = con.createStatement();
                    st.executeUpdate(sql);
                    JOptionPane.showMessageDialog(null, "Tipo de Matador Eliminado");
                    limpiarTabla(model);
    ...
    void Reactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Matador Activado");
                limpiarTabla(model);
    ...
    void Inactivar(){
        ...
        try {
                ...
                st = con.createStatement();
                st.executeUpdate(sql);
                JOptionPane.showMessageDialog(null, "Tipo de Matador Inactivado");
                limpiarTabla(model);
    ...
    public static void main(String args[]) {
        ...
        new TipoMatador().setVisible(true);
